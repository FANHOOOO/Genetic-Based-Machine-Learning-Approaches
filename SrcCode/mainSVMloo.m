...
exgene1(:,1)=2:71;
[BCESVM, Err1, Err2] = SVMloo(Training.data,Testing.data,exgene1,Y,Yt);
BCESVM
...
[BCESVM, Err1, Err2] = SVMloo(Training.data,Testing.data,exgene2,Y,Yt);
BCESVM
ChosenGene = GeneName(:,BCESVM)
ErrorEstimate = Err1
HandoutEstimate = Err2
...
[BCESVM, Err1, Err2] = SVMloo(Training.data,Testing.data,exgene3,Y,Yt);
BCESVM
ChosenGene = GeneName(:,BCESVM)
ErrorEstimate = Err1
HandoutEstimate = Err2
...
sfsgene1(:,1)=2:71;
[BCSSVM, Err1, Err2] = SVMloo(Training.data,Testing.data,sfsgene1,Y,Yt);
BCSSVM
...
[BCSSVM, Err1, Err2] = SVMloo(Training.data,Testing.data,sfsgene2,Y,Yt);
BCSSVM
...
[BCSSVM,Err1, Err2] = SVMloo(Training.data,Testing.data,sfsgene3,Y,Yt);
BCSSVM
...
[BCSSVM, Err1, Err2] = SVMloo(Training.data,Testing.data,sfsgene4,Y,Yt);
BCSSVM
...
[BCSSVM, Err1, Err2] = SVMloo(Training.data,Testing.data,sfsgene5,Y,Yt);
BCSSVM
