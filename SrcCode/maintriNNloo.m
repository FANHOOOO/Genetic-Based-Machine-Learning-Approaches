...
exgene1(:,1)=2:71;
[BCE3NN, Err1, Err2] = triNNloo(Training.data,Testing.data,exgene1,Y,Yt);
BCE3NN
...
[BCE3NN, Err1, Err2] = triNNloo(Training.data,Testing.data,exgene2,Y,Yt);
BCE3NN
ChosenGene = GeneName(:,BCE3NN)
ErrorEstimate = Err1
HandoutEstimate = Err2
...
[BCE3NN, Err1, Err2] = triNNloo(Training.data,Testing.data,exgene3,Y,Yt);
BCE3NN
ChosenGene = GeneName(:,BCE3NN)
ErrorEstimate = Err1
HandoutEstimate = Err2
...
sfsgene1(:,1)=2:71;
[BCS3NN, Err1, Err2] = triNNloo(Training.data,Testing.data,sfsgene1,Y,Yt);
BCS3NN
...
[BCS3NN, Err1, Err2] = triNNloo(Training.data,Testing.data,sfsgene2,Y,Yt);
BCS3NN
...
[BCS3NN,Err1, Err2] = triNNloo(Training.data,Testing.data,sfsgene3,Y,Yt);
BCS3NN
...
[BCS3NN, Err1, Err2] = triNNloo(Training.data,Testing.data,sfsgene4,Y,Yt);
BCS3NN
...
[BCS3NN, Err1, Err2] = triNNloo(Training.data,Testing.data,sfsgene5,Y,Yt);
BCS3NN
