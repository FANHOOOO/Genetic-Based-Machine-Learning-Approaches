...
exgene1(:,1)=2:71;
[BCELDA, Err1, Err2] = LDAloo(Training.data,Testing.data,exgene1,Y,Yt);
BCELDA
...
[BCELDA, Err1, Err2] = LDAloo(Training.data,Testing.data,exgene2,Y,Yt);
BCELDA
ChosenGene = GeneName(:,BCELDA)
ErrorEstimate = Err1
HandoutEstimate = Err2
...
[BCELDA, Err1, Err2] = LDAloo(Training.data,Testing.data,exgene3,Y,Yt);
BCELDA
ChosenGene = GeneName(:,BCELDA)
ErrorEstimate = Err1
HandoutEstimate = Err2
...
sfsgene1(:,1)=2:71;
[BCSLDA, Err1, Err2] = LDAloo(Training.data,Testing.data,sfsgene1,Y,Yt);
BCSFS1forLDA
ChosenGene1 = GeneName(:,BCSFS1forLDA)
ErrorEstimate1 = Err1
...
[BCSLDA, Err1, Err2] = LDAloo(Training.data,Testing.data,sfsgene2,Y,Yt);
BCSLDA
...
[BCSLDA,Err1, Err2] = LDAloo(Training.data,Testing.data,sfsgene3,Y,Yt);
BCSLDA
...
[BCSLDA, Err1, Err2] = LDAloo(Training.data,Testing.data,sfsgene4,Y,Yt);
BCSLDA
...
[BCSLDA, Err1, Err2] = LDAloo(Training.data,Testing.data,sfsgene5,Y,Yt);
BCSLDA
